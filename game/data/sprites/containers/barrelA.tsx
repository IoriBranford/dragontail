...
<tileset version="1.11" tiledversion="1.12.2" name="barrelA" tilewidth="32" tileheight="32" tilecount="3" columns="3" objectalignment="bottom">
 <editorsettings>
  <export target="barrelA.lua" format="lua"/>
 </editorsettings>
 <tileoffset x="0" y="8"/>
