...
<tileset version="1.11" tiledversion="1.12.2" name="tree2D_ss" tilewidth="32" tileheight="32" tilecount="256" columns="16">
 <editorsettings>
  <export target="tree2D_ss.lua" format="lua"/>
 </editorsettings>
 <image source="tree2D_ss.png" width="512" height="512"/>
 <tile id="0">
  <animation>
